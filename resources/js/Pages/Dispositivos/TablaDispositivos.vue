<template>
    ...
    <div class="overflow-auto rounded-lg shadow mt-7">
        ...
        <div class="mt-2 relative flex flex-row justify-items-start 2xl:justify-end xl:justify-end lg:justify-end">
            ...
            <input type="text"  v-model="busquedaDispositivos" class="h-14 w-25 px-12 rounded-lg hover:cursor-pointer z-index-10" placeholder="Buscar Dispositivo...">
        </div>
...
<script setup>
    ...
    let busquedaDispositivos = ref('');

    watch(busquedaDispositivos,(value) =>{

    router.get('/dispositivos',{ busquedaDispositivos: value},
    {
        preserveState: true,
        replace: true
